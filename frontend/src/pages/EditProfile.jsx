      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative">
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex flex-col items-center text-center">
            {userData.photoUrl ? <img src={userData?.photoUrl} alt="" className="w-24 h-24 rounded-full object-cover border-4 border-[black]"/> 
            : 
          ...
          <button
            type="submit"
            className="w-full bg-black hover:bg-gray-800 active:bg-[#454545] text-white py-2 rounded-md font-medium transition duration-200 transform hover:scale-[1.02] cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
            disabled={loading}
